# Revisor de Proyectos PGP — Prueba_Jesus
...
1. Crea el repositorio en tu cuenta (`Ocular19`) y sube este contenido:
   ```
   git remote add origin https://github.com/Ocular19/Prueba_Jesus.git
   git add -A
...
2. **Activa GitHub Pages**: Settings → Pages → Source: "Deploy from a branch",
   ...
   `https://ocular19.github.io/Prueba_Jesus/`.
...
4. **Agrega los secrets del repo**: Settings → Secrets and variables →
   ...
   - `MAIL_TO`: `coliveros@grenergy.eu,jsancho@grenergy.eu`.
